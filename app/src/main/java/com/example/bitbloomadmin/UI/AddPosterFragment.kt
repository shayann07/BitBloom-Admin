...
import com.example.bitbloomadmin.adapter.ImageAnnouncementAdapter
import com.example.bitbloomadmin.databinding.FragmentAddPosterBinding
import com.example.bitbloomadmin.models.ImageAnnouncement
...
class AddPosterFragment : Fragment() {
    ...
    private fun showAddPosterDialog() {
        ...
        val dialogView = LayoutInflater.from(requireContext())
            .inflate(R.layout.dialog_add_poster, null)
